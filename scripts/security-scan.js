...
const DANGEROUS_PATTERNS = [
  ...
  {
    pattern: /console\.(log|warn|error|info)\s*\([^)]*(password|token|secret|key)/i,
...
function scanFile(filePath, content) {
  ...
  ;[...DANGEROUS_PATTERNS, ...SQL_INJECTION_PATTERNS, ...INSECURE_PATTERNS].forEach(
    ({ pattern, message, severity, exclude }) => {
