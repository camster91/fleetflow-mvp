  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Fleetvera is free during the beta. Planned pricing after the beta is $49 monthly or $490 yearly."
        />
      </Head>
        ...
        <main className="px-4 pb-24 pt-36 sm:px-6">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mt-5 text-lg text-slate-600">
              Every beta workspace gets the full product at no cost. We will give beta workspaces advance notice before
              paid plans start.
            </p>
          </div>
            ...
            <div className="flex flex-col justify-between gap-6 sm:flex-row sm:items-start">
              ...
              <div className="text-left sm:text-right">
                <p className="text-3xl font-bold text-slate-950">
                  Free <span className="text-base font-normal text-slate-500">during beta</span>
                </p>
