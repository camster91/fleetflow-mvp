                ...
                <div className="space-y-5">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <button
                      ...
                      className="flex items-center gap-2 px-3 py-1.5 border border-slate-300 rounded-lg text-sm text-slate-400 cursor-not-allowed"
                    >
                  ...
                  <div className="grid sm:grid-cols-2 gap-4">
                    ...
                    <div>
                      <label htmlFor="settings-email" className={labelCls}>
                        Email
                      </label>
                      <input
                        id="settings-email"
                  ...
                  <div>
                    <label htmlFor="settings-bio" className={labelCls}>
                      Bio
                    </label>
                    <textarea
                      id="settings-bio"
              ...
              {activeTab === 'notifications' && (
                <div className="space-y-5">
                  ...
                  {[
                    {
                      key: 'emailDeliveries',
                      label: 'Email — Delivery updates',
                      desc: 'Get notified when deliveries change status',
                    },
                    {
                      key: 'emailMaintenance',
                      label: 'Email — Maintenance alerts',
                      desc: 'Reminders for upcoming and overdue tasks',
                    },
                    {
                      key: 'pushDeliveries',
                      label: 'Push — Delivery updates',
                      desc: 'Real-time push notifications for deliveries',
                    },
                    {
                      key: 'pushMaintenance',
                      label: 'Push — Maintenance alerts',
                      desc: 'Push alerts for maintenance tasks',
                    },
                    {
                      key: 'weeklyReports',
                      label: 'Weekly summary report',
                      desc: 'A weekly digest of your fleet activity',
                    },
                  ].map(({ key, label, desc }) => (
                    <div
                      key={key}
                ...
                <div className="space-y-5">
                  ...
                  <div className="grid sm:grid-cols-2 gap-4">
                    {[
                      ...
                      <div key={key}>
                        <label htmlFor={`settings-${key}`} className={labelCls}>
                          {label}
                        </label>
                        <select
                          id={`settings-${key}`}
