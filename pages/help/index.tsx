...
const topics = [
  {
    ...
    steps: [
      ...
      'Open the one-time code email.',
      'Enter the code; complete the 2FA challenge if your account has it enabled.',
    ],
  },
  {
    title: 'Set up a workspace',
    steps: [
      'Add the first vehicle and its current operational details.',
      'Create client records used by deliveries.',
      'Invite teammates from Team and assign the least-privileged role they need.',
    ],
  },
  {
    title: 'Run daily operations',
    steps: [
      'Create and update deliveries as work progresses.',
      'Schedule maintenance tasks and record estimated costs.',
      'Use Reports and Analytics to review activity; export CSV when needed.',
    ],
  },
  {
    title: 'Protect the account',
    steps: [
      'Enable authenticator-based 2FA under Settings > Security.',
      'Store backup codes somewhere separate from the device.',
      'Review API keys and team membership regularly.',
    ],
  },
]
          ...
          <div className="mx-auto max-w-4xl">
            <div className="text-center">
              ...
              <p className="mx-auto mt-4 max-w-2xl text-slate-600">
                A practical quick start for invited workspace members.
              </p>
            </div>
            ...
            <div className="mt-10 rounded-2xl bg-blue-950 p-8 text-center text-white">
              ...
              <Link
                href="/auth/login"
                className="mt-6 inline-block rounded-xl bg-white px-5 py-3 font-semibold text-blue-950 hover:bg-blue-50"
              >
                Sign in
              </Link>
            </div>
