...
export const EMAIL_DELIVERY_TIMEOUT_MS = positiveInteger(process.env.EMAIL_DELIVERY_TIMEOUT_MS, 4_000)
...
export async function ensureMinimumResponseDuration(startedAt: number, options: TimingOptions = {}): Promise<void> {
