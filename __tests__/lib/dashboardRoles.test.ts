...
describe('resolveDashboardRole', () => {
  test.each([
    ...
    ['TECHNICIAN', 'maintenance'], ['MAINTENANCE', 'maintenance'],
  ...
  test('exports every assignable operational role', () => {
    expect(TeamRole).toEqual(expect.objectContaining({ DISPATCHER: 'DISPATCHER', TECHNICIAN: 'TECHNICIAN', DRIVER: 'DRIVER' }))
  })
})
