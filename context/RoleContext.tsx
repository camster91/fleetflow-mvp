...
export const RoleProvider: React.FC<RoleProviderProps> = ({ children, initialRole = 'fleet_manager' }) => {
  ...
  return <RoleContext.Provider value={{ currentUser, switchRole, isAuthorized }}>{children}</RoleContext.Provider>
}
