...
export default function AdminDashboard(props: CommandCentreProps) {
  const [showSetup, setShowSetup] = useState(!props.onboardingCompleted)
  return (
    <CommandShell
    ...
    >
      {showSetup && <SetupChecklist onDismiss={() => setShowSetup(false)} />}
      <IntelligenceBrief />
      <Exceptions {...props} />
