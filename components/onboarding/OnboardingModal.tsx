...
import { Truck, Users, Wrench, CheckCircle, ChevronRight, ChevronLeft, Sparkles, X } from 'lucide-react'
import { notify } from '../../services/notifications'
import { getLocalOnboardingProgress, saveLocalOnboardingProgress, completeOnboarding } from '../../lib/onboarding'
  ...
  const steps: Step[] = [
    {
      ...
      content: (
        <div className="text-center space-y-4">
          ...
          <h3 className="text-xl font-semibold text-slate-900">Welcome to Fleetvera!</h3>
          <p className="text-slate-600 max-w-sm mx-auto">
            We\'re excited to help you manage your fleet more efficiently. This quick setup will guide you through the
      ...
      content: (
        <div className="space-y-4">
          ...
          <p className="text-slate-600">
            You can add vehicles manually or import them from a CSV file. Each vehicle can be tracked with GPS,
            maintenance history, and driver assignments.
          </p>
    ...
    },
    {
      ...
      content: (
        <div className="space-y-4">
          ...
          <p className="text-slate-600">
            Invite your team members to collaborate. You can assign different roles to control what each person can
            access and modify.
          </p>
        </div>
      ),
    },
    {
      ...
      content: (
        <div className="space-y-4">
          ...
          <p className="text-slate-600">
            Proactive maintenance helps prevent breakdowns and extends vehicle life. Set up maintenance schedules for
    ...
    },
    {
      ...
      content: (
        <div className="text-center space-y-4">
          ...
          <h3 className="text-xl font-semibold text-slate-900">You\'re Ready to Go!</h3>
          <p className="text-slate-600 max-w-sm mx-auto">
            You\'ve completed the initial setup. You can always access these features from your dashboard. Check the
            setup checklist to track your progress.
          </p>
      ...
      footer={
        <div className="flex items-center justify-between w-full">
          <div className="flex items-center gap-2">
            <ProgressRing progress={progress} size={40} strokeWidth={3} showPercentage />
          ...
          <div className="flex items-center gap-3">
            {currentStep > 0 && (
              <Button variant="ghost" onClick={handlePrevious} iconLeft={<ChevronLeft className="h-4 w-4" />}>
                Back
              </Button>
            )}
            <Button
